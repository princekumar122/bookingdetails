      ...
      children: [
              ...
              Padding(
                ...
                child: ConstrainedBox(
                  constraints: BoxConstraints(
                      maxWidth: MediaQuery.of(context).size.width * 0.2,
                      maxHeight: MediaQuery.of(context).size.height * 0.09),
                  child: buttons(AppStrings.ACCEPTED, context, "Accepted"),
                ),
              ),
              Padding(
                padding: const EdgeInsets.only(
                ...
                child: ConstrainedBox(
                    constraints: BoxConstraints(
                        ...
                        maxHeight: MediaQuery.of(context).size.height * 0.09),
                    child: buttons(
                        AppStrings.HISTORY_BOOKING, context, "History")),
              ),
              Padding(
                padding: const EdgeInsets.only(
                  left: 10,
        ...
        Expanded(
          child: Container(
            ...
            child: tab == AppStrings.HISTORY_BOOKING
                ? HistoryBookings()
                : Accepted(),
          ),
        )
  ...
  Widget buttons(String navigationTab, BuildContext context, var title) {
    return ListTile(
      ...
      leading: ElevatedButton(
          onPressed: () {
            Get.toNamed(
                '/home/${AppStrings.SALES}/booking-view/${navigationTab}');
          },
          style: ButtonStyle(
